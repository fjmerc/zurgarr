...
with modifications applied for integration into Zurgarr.
...
vendored copy is preserved here so Zurgarr can ship a self-contained
Docker image with attribution to the original author. Zurgarr does
...
Zurgarr-side wrappers, vendoring, or modifications should be reported
to the Zurgarr issue tracker.
